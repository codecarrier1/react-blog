...
module.exports = {
  ...
  'menu.': 'dsds',
  'user.name': 'Name',
  'user.passwordConf': 'Confirm Password',
  ...
  /* Client Page */
  'client.myTrainers': 'My Trainers',
  'client.packages': 'Trainer Packages',
  'client.purchase': 'Purchase',
  'client.sessions.completed': 'Completed Sessions',
  'client.sessions.remaining': 'Remaining Sessions',
  'client.sessions.weighIns': 'Weigh Ins',
  'client.sessions.nonPT': 'Complete Non PT Workout',
  /* 03.Menu */
  'menu.app': 'Home',
  ...
  /* 06.03.board */
  'board.add-new': 'ADD NEW',
  'board.add-new-title': 'Add New board',
  'board.title': 'Title',
  'board.detail': 'Detail',
  ...
  'board.submit': 'Submit',
  'Board.action': 'Action',
  'Board.another-action': 'Another action',
  'board.Display-options': 'Display Options',
  'Board.orderby': 'Order By : ',
  'board.all-tasks': 'All Tasks',
  'board.pending-tasks': 'Pending Tasks',
  'board.completed-tasks': 'Completed Tasks',
